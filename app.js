...
export default () => {
    ...
    app.post('/process_post', urlencodedParser, function (req, res) {
        ...
        toyotaData.collect(response).then(tripInfos_ => {
            ...
            res.end(JSON.stringify({tripInfos: Object.assign({}, tripInfos_), totalDistanceInKm: totalDistanceInKm, averageFuelConsumption: averageFuelConsumption, overallFuelConsumption: overallFuelConsumption}));
